...
mod tests {
    use super::*;
    use plushie_core::testing::{node as make_node, node_with_props};
    use serde_json::json;

    fn make_text_node(id: &str, content: &str) -> plushie_core::protocol::TreeNode {
    ...
    fn core_with_tree() -> Core {
        ...
        core.apply(plushie_core::protocol::IncomingMessage::Snapshot { tree: root });
        core
    }
