...
pub fn emit_hello(
    ...
    let msg = serde_json::json!({
        "type": "hello",
        "session": "",
        "protocol": plushie_core::protocol::PROTOCOL_VERSION,
...
/// Encode and write an [`EffectResponse`](plushie_core::protocol::EffectResponse).
pub fn emit_effect_response(response: plushie_core::protocol::EffectResponse) -> io::Result<()> {
    let codec = Codec::get_global();
